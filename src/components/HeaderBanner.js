        ...
        <div className="flex flex-col">
          ...
          <div className='mt-72 z-2 '>
              ...
              <div className='text-white indie'>
                ...
                <div className='mt-12'>Thus, we offer Waldos access to truly exclusive advantages through this crazy project!</div>
