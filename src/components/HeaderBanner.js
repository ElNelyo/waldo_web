...
const HeaderBanner = () => (
  ...
  />
    ...
    <div className="bg-gradient-to-r from-violet-900 to-blue-500 mt-32 sm:mt-72 w-full block  pb-32" id='genesis'>
      <div className="pt-12 px-4 sm:px-6 lg:px-8 lg:pt-20">
        <div className="text-center">
          <Zoom>
          <div className='mt-72 z-2 '>
              <div className='uppercase text-4xl text-white pacifico mb-12'>
                  The Waldos Legend: What is it?!
              </div>

              <div className='text-white indie'>
                  <div className='text-white indie'>THE WALDOS LEGEND is the realization of a wacky project created by a talented and ambitious team. Passionate about blockchain, NFT and especially hemp cultivation, we are creating through the Waldos the first NFT project focused on CBD.</div>
            ...
            <div className='relative sm:mb-72 mx-auto w-full left-1/4 mt-10 pb-10' >
                <img src={background_dino} className="w-1/2 mx-auto absolute rounded-3xl shadow-xl"></img>
                <ReactFloaterJs>
