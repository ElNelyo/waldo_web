...
const navigation = {
    ...
    social: [
      ...
      {
        name: 'Twitter',
        href: 'https://twitter.com/WaldosLegend',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      {
        name: 'Discord',
        href: 'https://discord.gg/4jYmvufSFT',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 30 30" width="60px" height="60px"  {...props}>
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex justify-center space-x-6">
            {navigation.social.map((item) => (
              <a key={item.name} target="_blank" href={item.href} className="text-gray-100 hover:text-black">
