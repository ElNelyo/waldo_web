...
export default function Benefits() {
  return (
    ...
    <Zoom>
      <div className='text-4xl mx-auto text-center pacifico uppercase text-blue-700'>What'is next ?</div>
      </Zoom>
      <Zoom>
  ...
  <Zoom><div className='text-white text-center text-xl mx-auto mb-12 indie'> Indeed, the DAO will help define future projects for THE WALDOS LEGEND! We are listening!</div> </Zoom>
